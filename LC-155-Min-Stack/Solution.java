...
5. For pop(), pop the element from top of the stack, and also check if this value is equal to the top of minStack, if it is, it needs to be removed from minStack as well
